...
// Load Plugins
const pluginFiles = [
    'nsfw-girls.js','autobio.js','dl-xdown.js','attp.js','generale.js',
    'groupstatus.js','vv.js','video.js','get-pairrrrrrrrrrr.js','unblock.js',
    'gc-setting.js','allmenu.js','online.js','ping.js','alive.js',
    'anti-delete.js','ss.js'
];
    ...
    try {
        ...
        conn.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'open') {
                await arslanmd(conn);
                // Auto join channels
                try { const { autoJoinChannels } = require('./allmenu'); await autoJoinChannels(conn); } catch(_) {}
